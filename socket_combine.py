...
from old_code.socketio_auto_request import start_auto_request

panel_1_ip = "ws://192.168.88.233:81/panel_1"
...
auto_request_machine = Thread(target = start_auto_request, args = [998,"ws://localhost:12000"])
